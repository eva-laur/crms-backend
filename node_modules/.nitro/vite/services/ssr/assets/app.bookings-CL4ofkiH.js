import { a as can, s as useRole } from "./role-context-YJO8G-xL.js";
import { a as AppHeader, i as CardTitle, n as CardContent, o as Badge, r as CardHeader, t as Card } from "./card-eBpIeksT.js";
import { r as getBookings } from "./bookings-BMnMGXf-.js";
import { r as getMyReservations } from "./bus-CesgH2y4.js";
import { useMemo } from "react";
import { Navigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { Bus, ClipboardList } from "lucide-react";
//#region src/routes/app.bookings.tsx?tsr-split=component
var STATUS_TONE = {
	approved: "success",
	checked_out: "success",
	confirmed: "success",
...
function BookingsPage() {
	const { user } = useRole();
	if (!can(user?.role, "nav:bookings")) return /* @__PURE__ */ jsx(Navigate, { to: "/app/dashboard" });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(AppHeader, {
		...
		children: /* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs(CardHeader, { children: [/* @__PURE__ */ jsxs(CardTitle, {
				...
				children: [/* @__PURE__ */ jsx(ClipboardList, { className: "h-4 w-4 text-primary" }), " Personal booking log"]
			}), /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}), /* @__PURE__ */ jsxs("tbody", { children: [!isLoading && rows.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
						colSpan: 5,
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsxs(Badge, {
										...
										children: [r.kind === "bus" ? /* @__PURE__ */ jsx(Bus, { className: "h-3 w-3" }) : /* @__PURE__ */ jsx(ClipboardList, { className: "h-3 w-3" }), r.kind === "bus" ? "Bus" : "Resource"]
									})
								}),
								/* @__PURE__ */ jsx("td", {
